...
<!--    Menu for login person-->
    <div class="menuContainer">
        <a href="index.php?view=add_person" title="Dodaj nową osobę">Dodaj nową osobę</a>
        <a href="index.php?view=add_contact" title="Dodaj nowy kontakt">Dodaj kontakt</a>
        <a href="index.php?view=add_address" title="Dodaj nowy adres">Dodaj adres</a>
